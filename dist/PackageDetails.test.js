import { getPackageDetailsFromPatchFilename, getPatchDetailsFromCliString, parseNameAndVersion, } from "./PackageDetails";
...
`);
        expect(getPackageDetailsFromPatchFilename("@types+banana++@types+apple++@mollusc+man+0.4.2-banana-tree.patch")).toMatchInlineSnapshot(`
Object {
...
`);
        expect(getPackageDetailsFromPatchFilename("@types+banana.patch++hello+0.4.2-banana-tree.patch")).toMatchInlineSnapshot(`
Object {
...
`);
        expect(getPackageDetailsFromPatchFilename("@types+banana.patch++hello+0.4.2-banana-tree.dev.patch")).toMatchInlineSnapshot(`
Object {
  "humanReadablePathSpecifier": "@types/banana.patch => hello",
  "isDevOnly": true,
  "isNested": true,
...
`);
        expect(getPackageDetailsFromPatchFilename("@microsoft/api-extractor+2.0.0+01+FixThing")).toMatchInlineSnapshot(`
Object {
...
`);
    ...
    it("handles a scoped package name", () => {
        expect(getPatchDetailsFromCliString("@david/patch-package")).toMatchInlineSnapshot(`
Object {
...
`);
    ...
    it("handles a nested package name with scopes", () => {
        expect(getPatchDetailsFromCliString("@david/patch-package/banana")).toMatchInlineSnapshot(`
Object {
...
`);
        expect(getPatchDetailsFromCliString("@david/patch-package/@david/banana")).toMatchInlineSnapshot(`
Object {
