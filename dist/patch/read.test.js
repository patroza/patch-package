...
`);
    ...
    it("throws an error for scoped packages", () => {
        readPatch({
            ...
            patchDetails: getPackageDetailsFromPatchFilename("@david+test+1.2.3.patch"),
            patchDir: "patches/",
        });
        expect(removeAnsiCodes(lastLog())).toMatchInlineSnapshot(`
"
